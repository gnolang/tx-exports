...
- **Active**: mainnet.gno.land (`gnoland-1`), onyx.gno.land (test17), pearl.gno.land (test16), staging.gno.land
...
- `.github/workflows/txs-exporter.yml` — runs every 4 hours for mainnet.gno.land, onyx.gno.land, and pearl.gno.land
