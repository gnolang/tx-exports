module github.com/gnolang/gno/tx-exports/extractor

go 1.25.9

require (
	github.com/gnolang/gno v0.0.0-20260618143455-98f4db57cbfc
	github.com/gnolang/gno/contribs/tx-archive v0.0.0-20260618143455-98f4db57cbfc
