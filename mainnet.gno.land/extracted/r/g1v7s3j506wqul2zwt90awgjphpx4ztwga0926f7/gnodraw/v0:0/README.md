...
Realm `gno.land/r/g1v7s3j506wqul2zwt90awgjphpx4ztwga0926f7/gnodraw/v0`: a 1250 x 800 (one million pixels, 16:10) pay-per-pixel canvas
built on `gno.land/p/g1v7s3j506wqul2zwt90awgjphpx4ztwga0926f7/canvas/v0`.

Paint from the CLI:

```sh
gnokey maketx call -pkgpath gno.land/r/g1v7s3j506wqul2zwt90awgjphpx4ztwga0926f7/gnodraw/v0 -func PaintBatch \
